...
export default function SideBar(){
    return (
        <div className="grid h-svh max-h-screen grid-rows_[1fr_50px] bg-stone-100 text-black">
           <div className="flex flex-col text-black overflow-hidden">
               <div className='px-2'>
                   <h6 className="px-2 py-1 mt-2 mb-2 text-slate-700 flex-1">Blog Generator</h6>
                   <div className='w-full flex'>
                       <Link
                           className='px-2 py-1 mb-2 flex-1 flex flex-row items-center hover:bg-stone-200 hover:text-black rounded text-slate-700'
                           href='/post/new'>
